          ...
          <div className="border border-gray-300 rounded-md overflow-hidden mb-8">
            <div className="bg-gray-100 p-4 border-b border-gray-300">
              ...
              <p className="text-sm text-gray-500 mt-1">
                {courseData.courseContent.length} sections • {totalLectures}{" "}
                lectures • {durationString} total duration
              </p>
            </div>
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      <ul className="text-sm text-gray-600 bg-white">
                        {chapter.chapterContent.map((lecture, i) => (
                          <li
                            key={i}
                            className="flex items-center justify-between p-3 pl-8 border-t border-gray-100 hover:bg-gray-50"
                          >
                            <div className="flex items-center gap-2">
                              <svg
